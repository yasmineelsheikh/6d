...
export default function TestRunsTab({ datasetName, datasetData }: TestRunsTabProps) {
    return (
        <div className="space-y-6">
            <div>
                <span className="text-[10px] uppercase tracking-widest text-[#666] font-medium">Upload Test Data</span>
            ...
            <div>
                <span className="text-[10px] uppercase tracking-widest text-[#666] font-medium">Episode Browser</span>
                <div className="mt-3 bg-white/5 border border-white/10 rounded-xl p-5">
