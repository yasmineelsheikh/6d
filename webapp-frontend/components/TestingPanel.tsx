    ...
    <div>
      <div className="mb-3">
        <input
          ...
          className="w-full px-3 py-2 bg-[#1a1a1a] border border-white/10 text-white placeholder:text-white/20 text-xs focus:outline-none focus:border-white/20 transition-colors"
        />
      </div>
      <button
